...
% subject number... 
if subj.num < 10
    results_tag = ['00' num2str(subj.num) '_' subj.init '_priming_reg_irreg_' date];
elseif subj.num < 100
    results_tag = ['0' num2str(subj.num) '_' subj.init '_priming_reg_irreg_' date];
elseif subj.num < 1000
    results_tag = [num2str(subj.num) '_' subj.init '_priming_reg_irreg_' date];
else
